...
final class AutodetectingGitLabClient implements GitLabClient {
    ...
    @Override
    public void createNewTag(final Integer projectId, final String ref, final String tagName, final String message, final String releaseDescription) {
        execute(
            new GitLabOperation<Void>() {
                @Override
                Void execute(GitLabClient client) {
                    client.createNewTag(projectId, ref, tagName, message, releaseDescription);
                    return null;
                }
            });
    }
    ...
    @Override
    public void createNewRelease(final Integer projectId, final String tagName, final String description) {
        execute(
            new GitLabOperation<Void>() {
                @Override
                Void execute(GitLabClient client) {
                    client.createNewRelease(projectId, tagName, description);
                    return null;
                }
            });
    }
    ...
    @Override
    public List<Tag> getTags(final Integer projectId) {
        return execute(
            new GitLabOperation<List<Tag>>() {
                @Override
