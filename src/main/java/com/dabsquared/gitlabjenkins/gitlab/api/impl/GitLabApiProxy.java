...
interface GitLabApiProxy {
    ...
    void createNewTag(Integer projectId, String ref, String tagName, String message, String releaseDescription);

    void createNewRelease(Integer projectId, String tagName, String description);
